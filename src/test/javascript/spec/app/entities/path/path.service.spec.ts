...
describe('Service Tests', () => {
  describe('Path Service', () => {
    ...
    let elemDefault: IPath;
    let expectedResult: IPath | IPath[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      elemDefault = new Path(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Path', () => {
        ...
        service.create(new Path()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Path', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            path: 'BBBBBB',
