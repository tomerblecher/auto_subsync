...
import { PathComponent } from 'app/entities/path/path.component';
  ...
  describe('Path Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PathComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.paths && comp.paths[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
