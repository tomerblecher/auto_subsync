...
import { ExtensionComponent } from 'app/entities/extension/extension.component';
...
describe('Component Tests', () => {
  describe('Extension Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.extensions && comp.extensions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
