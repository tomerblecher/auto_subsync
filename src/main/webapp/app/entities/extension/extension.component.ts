...
export class ExtensionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.extensionService
      ...
      .subscribe(
        (res: HttpResponse<IExtension[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInExtensions(): void {
    this.eventSubscriber = this.eventManager.subscribe('extensionListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IExtension[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
